...
thr = 10 # threshold distance to the goal for making decision 
v = 10  # agent speed
obstacle_width=10  # obstacle width

final_route = {} # coordinates for the final route
